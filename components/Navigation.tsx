...
const Navigation: React.FC<NavigationProps> = ({ 
  ...
  return (
    <>
      ...
      {!hideTabs && (
        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-2 z-50 w-full max-w-2xl px-4 flex items-start justify-center gap-2 pointer-events-none">
          {tabs.map((tab, index) => (
            <button 
              key={tab.id} 
