...
const NotepadContainer: React.FC<NotepadContainerProps> = ({ children, navigation, title }) => {
  return (
    <div className="relative w-full">
      <div className="bg-[#fffdf2] border-2 border-stone-200 rounded-t-[2rem] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.15)] relative z-10 min-h-[calc(100vh-180px)] flex flex-col paper-texture torn-edge-bottom pb-12">
        
        {/* Black Book Binding */}
        <div className="h-16 bg-[#1a1a1a] border-b border-black relative z-20 overflow-visible shadow-lg">
        ...
        {/* Binder Holes Column */}
        <div className="absolute left-4 top-20 bottom-0 w-8 binder-holes opacity-40 pointer-events-none z-20"></div>

        {/* Content Area */}
        <div className="flex-1 flex flex-col overflow-y-auto pl-16">
          {children}
        </div>
      </div>
